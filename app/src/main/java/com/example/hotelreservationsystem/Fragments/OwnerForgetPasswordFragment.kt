...
lateinit var binding: FragmentOwnerForgetPasswordBinding
    ...
    override fun onCreateView(
        ...
        binding.sendOtp.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_ownerForgetPasswordFragment_to_ownerOtpVerificationFragment);
        }
        binding.backToLogin.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_ownerForgetPasswordFragment_to_ownerLoginFragment);
        }
