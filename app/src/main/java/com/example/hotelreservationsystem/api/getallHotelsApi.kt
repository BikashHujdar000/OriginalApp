...
//https://anxious-gaiters-bee.cyclic.app/user/bookroom/647034fa7f9bac4c2cb46119/646da91c4cd9ef9e30a5ad4a/646deb68e1b59be01864c43d
    ...
    suspend fun bookRoom(@Path("userId")userId: String,@Path("hotelId")hotelId:String,@Path("roomId")roomId:String,@Body bookRequest: BookRequest):Response<BookHudaKoResponse>
